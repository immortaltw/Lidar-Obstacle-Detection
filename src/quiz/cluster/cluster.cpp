...
int main ()
{
	...
	// std::vector<std::vector<float>> points = { {-6.2,7,0.3}, {-6.3,8.4,0.3}, {-5.2,7.1,0.3}, {-5.7,6.3,0.3}, {7.2,6.1,0.3}, {8.0,5.3,0.3}, {7.2,7.1,0.3}, {0.2,-7.1,0.3}, {1.7,-6.9,0.3}, {-1.2,-7.2,0.3}, {2.2,-8.9,0.3} };
